...
% MRiLab Version 1.3                           %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [rfAmp,rfPhase,rfFreq,rfCoil,GzAmp,GyAmp,GxAmp,ADC,Ext,uts,ts,flags]=PSD_SE3D
global VCtl
global VVar
CV1=1e-3;
CV10=0;
...
p.rfFreq=0;
p.rfPhase=pi/2;
p.tEnd=VCtl.TE/2+1e-3;
p.tStart=VCtl.TE/2-1e-3;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
