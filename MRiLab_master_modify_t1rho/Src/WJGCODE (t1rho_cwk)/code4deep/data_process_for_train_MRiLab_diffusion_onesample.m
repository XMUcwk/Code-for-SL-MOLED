...
clear 
%close all
dirname='/data2/mlc/MRiLab/sample1/';
outputdir = ['/data2/mlc/MRiLab/charles_for_train/charles_for_7t_phantom_b1000_woB1/'];
fid_dir_all=dir([dirname,'data_for_7t_phantom_b1000_woB1*']);       %list all directories
phase_num=128;
fre_num = 128;
expand_num = 256;
sigma=0.6e-2;
...
%         max4norm = max(abs(I1(:)));
        I1 = I1/max4norm;
        both_img_noise=0;%normrnd(0,sigma,expand_num,expand_num)+1.0i*normrnd(0,sigma,expand_num,expand_num);
